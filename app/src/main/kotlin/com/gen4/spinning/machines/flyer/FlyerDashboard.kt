...
fun FlyerDashboard(
    ...
    val vm: FlyerViewModel = viewModel(factory = flyerVmFactory(app, repository))
...
fun flyerVmFactory(app: Application, repository: BtSessionRepository) =
    object : ViewModelProvider.Factory {
        @Suppress("UNCHECKED_CAST")
        override fun <T : ViewModel> create(modelClass: Class<T>): T =
            FlyerViewModel(app, repository) as T
    }
